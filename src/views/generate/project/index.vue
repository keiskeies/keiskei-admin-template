<template>
  <div class="app-container">
    <div class="table-container">
      <base-list ref="table" url="/generate/project" :options="options" :columns="columns" :format="format" :rules="rules"
                 @reloadOptions="handleGetOptions" permission="generate:project" editPage></base-list>
    </div>
  </div>
</template>
