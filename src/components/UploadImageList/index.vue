<template>
  <div class="upload-image-list-content">
    <el-upload accept=".jpg, .jpeg, .png" :action="requestData.requestUrl" list-type="picture-card"
               :headers="requestData.headerToken" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload"
               :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :multiple='multipleStatus'
               :file-list="imageList" :limit="limitNumber">
...
export default {
  ...
  methods: {
    handleRemove(file, fileList) {
      ...
      this.$emit("uploadSuccess", data, this.index, this.columnName);
    },
